...
const dynamic = {
    theme_alphatrade: [
        ...
        ...['beginner', 'intermediate', 'advanced'].map((k) => 'pub_level_' + k),
    ...
    local_alphatrade: [
        ...
        ...['beginner', 'intermediate', 'advanced'].map((k) => 'level_' + k),
        ...
        ...['userid', 'name', 'market', 'timeframe', 'period', 'description', 'timecreated', 'timemodified', 'strategyid',
            ...
            'application_fullname', 'application_email', 'application_phone', 'application_level', 'application_motivation', 'core_files',
